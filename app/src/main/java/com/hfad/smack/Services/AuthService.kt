package com.hfad.smack.Services
...
import com.hfad.smack.Utilities.URL_Create_User
import com.hfad.smack.Utilities.URL_LOGIN
import com.hfad.smack.Utilities.URL_REGISTER
    ...
    fun createUser(
        ...
        val createRequest = object :
            ...
            override fun getHeaders(): MutableMap<String, String> {
                ...
                val put = headers.put("Authorization", "Bearer $authToken")
                return headers
